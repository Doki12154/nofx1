...
export const translations = {
  en: {
    ...
    triggerAnalysisHint: 'Manually trigger AI analysis immediately',
    triggeringAnalysis: 'Triggering analysis...',
    analysisTriggered: 'Analysis started successfully',
  ...
  zh: {
    ...
    triggerAnalysisHint: '手动触发AI分析，立即重新评估市场机会',
    triggeringAnalysis: '正在触发分析...',
    analysisTriggered: '已成功触发分析',
