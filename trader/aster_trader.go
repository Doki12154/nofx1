...
// GetTradingFee Get Aster trading fee rate
// Aster typical fee: taker 0.05%
func (a *AsterTrader) GetTradingFee() (float64, error) {
	// Aster typical fee structure
	logger.Debugf("Aster trading fee: taker=0.05%% (default)")
	return 0.0005, nil
}
