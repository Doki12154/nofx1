...
type Trader interface {
	...
	// GetTradingFee Get trading fee rate for the account
	// Returns: takerFeeRate (opening position uses taker rate)
	// Used for accurate margin calculation before opening positions
	GetTradingFee() (float64, error)
}
